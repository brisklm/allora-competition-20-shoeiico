...
SELECTED_FEATURES = ['sign_log_return_lag1_SOLUSDT', 'momentum_SOLUSDT', 'rsi_SOLUSDT', 'volatility_SOLUSDT', 'volatility_ETHUSDT', 'close_SOLUSDT_lag1', 'close_ETHUSDT_lag1', 'hour_of_day', 'close_SOLUSDT_lag30', 'close_BTCUSDT_lag30', 'close_ETHUSDT_lag30']
